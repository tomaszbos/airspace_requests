"""
Django settings for airspace_request project.
...
ROOT_URLCONF = 'airspace_request.urls'
...
WSGI_APPLICATION = 'airspace_request.wsgi.application'
...
try:
    from airspace_request.local_settings import DATABASES
except ModuleNotFoundError:
